...
public class ZkRegistryServiceImpl implements RegistryService {
    ...
    public static final String ZK_BASE_PATH = "/rpc_self";
    private final ServiceDiscovery<ServiceMeta> serviceDiscovery;

    public ZkRegistryServiceImpl(String registryAddr) throws Exception {
    ...
    public ServiceMeta discovery(String serviceName, int hashCode) throws Exception {
        ...
        ServiceInstance<ServiceMeta> instance = new ZKConsistentHashLoadBalancer().select((List<ServiceInstance<ServiceMeta>>) serviceInstances, hashCode);
        if (instance != null) {
